    ...
    try {
        ...
        res.json({
            ...
            data: {
                ...
                momentsApiConfigId: user.momentsApiConfigId
            }
        });
    } catch (error) {
...
router.put('/api-selection', authMiddleware, async (req, res) => {
    try {
        const userId = req.user.userId;
        const { globalApiConfigId, textApiConfigId, imageApiConfigId, momentsApiConfigId } = req.body;
        ...
        res.json({
            ...
            message: '配置更新成功',
            data: {
                globalApiConfigId: globalApiConfigId ?? null,
                textApiConfigId: textApiConfigId ?? null,
                imageApiConfigId: imageApiConfigId ?? null,
                momentsApiConfigId: momentsApiConfigId ?? null
            }
        });
    } catch (error) {
